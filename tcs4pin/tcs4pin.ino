int s0=8; //Pin S0 ke Pin D3 Arduino
int s1=9; //Pin S1 ke Pin D3 Arduino
int s2=12; //Pin S2 ke Pin D3 Arduino
int s3=11; //Pin S3 ke Pin D3 Arduino
int out=10; //Pin OUT ke Pin D3 Arduino

...
void loop() 
{
   ...
   Serial.println(nilaiDayaQ);
    ...
    else if(nilaiDayaQ>=936 && nilaiDayaQ<=951) myport.send_8bit_data(62);
    else if(nilaiDayaQ>=936 && nilaiDayaQ<=951) myport.send_8bit_data(62);
    else if(nilaiDayaQ>=920 && nilaiDayaQ<=935) myport.send_8bit_data(61);
    else if(nilaiDayaQ>=905 && nilaiDayaQ<=919) myport.send_8bit_data(60);
    else if(nilaiDayaQ>=890 && nilaiDayaQ<=904) myport.send_8bit_data(59);
    else if(nilaiDayaQ>=875 && nilaiDayaQ<=889) myport.send_8bit_data(58);
    else if(nilaiDayaQ>=859 && nilaiDayaQ<=874) myport.send_8bit_data(57);
    else if(nilaiDayaQ>=844 && nilaiDayaQ<=858) myport.send_8bit_data(56);
    else if(nilaiDayaQ>=829 && nilaiDayaQ<=843) myport.send_8bit_data(55);
    else if(nilaiDayaQ>=814 && nilaiDayaQ<=828) myport.send_8bit_data(54);
    else if(nilaiDayaQ>=798 && nilaiDayaQ<=813) myport.send_8bit_data(53);
    else if(nilaiDayaQ>=783 && nilaiDayaQ<=797) myport.send_8bit_data(52);
    else if(nilaiDayaQ>=768 && nilaiDayaQ<=783) myport.send_8bit_data(51);
    else if(nilaiDayaQ>=753 && nilaiDayaQ<=767) myport.send_8bit_data(50);
    else if(nilaiDayaQ>=738 && nilaiDayaQ<=752) myport.send_8bit_data(49);
    else if(nilaiDayaQ>=720 && nilaiDayaQ<=737) myport.send_8bit_data(48);
    else if(nilaiDayaQ>=707 && nilaiDayaQ<=719) myport.send_8bit_data(47);
